...
label define out 1 "current-out migrants" 0 "Non current-out residents"
...
foreach var of numlist 1/10  {
 ...
 egen workabuse = rowtotal(abuse1-abuse10)
...
egen offwabuse = rowtotal(offabuse1-offabuse10)
...
foreach var of varlist female agegroup muslim illi edu eduyr minor child impwater toilet{
    tab `var', m
}
...
***Work Experience: Abuse and subjective judgment of quality of living 

foreach var of varlist workabuse offwabuse{
...
************************************************************************
/* IV. Analysis: Restricted to Domestic current-out MIGRANTS (n = 606 ) */
************************************************************************
...
* Abuse and subjective judgment of quality of living 

foreach var in workabuse offwabuse q67 q68 {
    replace `var' = . if `var' == 88 
    anova `var' outmgt
...
* Age difference: Restricted within Domestic MIGRANTS (606 respondents)
     graph box q9 , over(outmgt) 

*********************************************************************
/* IV. Analysis: Restricted to Domestic Returned MIGRANTS (n = 126) */
*********************************************************************


 * Restricted within  ( 126 respondents)
   preserve
...
** Significant income difference between Male returned migrants and female 
 restore 
    

**************************************************************************************************
/* V Analysis: Restricted to migrants in poverty in Domestic Returned MIGRANTS (n = )*/ 
**************************************************************************************************
...
preserve
keep if income == 1 | income == 2

***Demographics

foreach var of varlist female edu minor muslim illi agegroup child impwater eduyr toilet{
    tab `var', m
}
